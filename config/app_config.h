...
#define THERMISTOR_B_VALUE 4000

#define UPDATE_INTERVAL_REMOTE_FUEL_GAUGE 1_s
#define UPDATE_INTERVAL_THROTTLE 400_ms
#define HALL_SENSOR_POWER_UP_DELAY 200_us